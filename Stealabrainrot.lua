...
local function Btn(parent, txt, pos, callback)
    ...
    b.MouseEnter:Connect(function() TS:Create(b, TweenInfo.new(0.15), {BackgroundColor3 = Color3.fromRGB(138, 43, 226)}):Play() end)
    b.MouseLeave:Connect(function() if not b:GetAttribute("Hovered") then TS:Create(b, TweenInfo.new(0.15), {BackgroundColor3 = Color3.fromRGB(25,25,25)}):Play() end end)
    if callback then b.MouseButton1Click:Connect(function() callback(b) end) end
    return b
end

-- GUI Setup
local GUI = Instance.new("ScreenGui", Plr:WaitForChild("PlayerGui"))
GUI.Name = "Fusion's Script Hub"
...
Title.Size, Title.Position, Title.Text = UDim2.new(1, -40, 0, 40), UDim2.new(0, 0, 0, 0), "⚡ Fusion's script hub"
...
local function Freecam()
    pcall(function() loadstring(game:HttpGet("https://raw.githubusercontent.com/GhostPlayer352/Test4/main/Freecam"))() end)
end
...
Btn(Content, "🎥 FREECAM", UDim2.new(0, 0, 0, 180), Freecam)
